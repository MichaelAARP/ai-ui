import './styles/AarpFooter.css';

const AarpFooter = () => (
  <footer className="aarp-footer">
    <div className="footer-container">
      ...
      <div className="footer-left">
        ...
        >
          <defs>
            <polygon
              id="path-1"
              points="0 0.879 114.9137 0.879 114.9137 26 0 26"
            ></polygon>
            <polygon
              id="path-3"
              points="0.9665 0.8791 6 0.8791 6 5.9801 0.9665 5.9801"
            ></polygon>
          </defs>
        ...
        <p className="footer-description">
          AARP is a nonprofit, nonpartisan organization that empowers people to
      ...
      <div className="footer-right">
        <div className="footer-grid">
          <a href="#">About Us</a>
          <a href="#">Advertise with AARP</a>
          <a href="#">Newsletter</a>
          <a href="#">AARP Foundation</a>

          <a href="#">Donate</a>
          <a href="#">Contact Us</a>
          <a href="#">AARP In Your City</a>
          <a href="#">Wish of a Lifetime</a>
          ...
          <a href="#">Legal Counsel for the Elderly</a>
        </div>
      </div>
    </div>
  </footer>
